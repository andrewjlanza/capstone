...
namespace recyclemeapi.Migrations
{
    ...
    [Migration("20181120154649_addedlocationmatsandmats")]
    partial class addedlocationmatsandmats
    {
            ...
            modelBuilder.Entity("recyclemeapi.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = -5, Address = "2250 26th Ave. S.", CenterName = "Pinellas County Recycling & Brush Site", City = "St. Petersburg", Latitude = 27.875891, Longitude = -82.67545, PhoneNumber = "", Rating = 3, State = "FL", Zip = "33712", weekdayHours = "Monday-Friday, 9 a.m. to 5:30 p.m.", weekendHours = "Saturday and Sunday, 8 a.m. to 5:30 p.m." },
                        ...
                        new { Id = -14, Address = "300 2nd Ave SE", CenterName = "Municipal Marina Drop-Off", City = "St. Petersburg", Latitude = 27.342242, Longitude = -82.494311, PhoneNumber = "", Rating = 4, State = "FL", Zip = "33701", weekdayHours = "", weekendHours = "" }
                    );
                });
