...
namespace recyclemeapi.Migrations
{
    ...
    [Migration("20181119192753_weekday")]
            ...
            modelBuilder.Entity("recyclemeapi.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = -8, Address = "456 imposter st", CenterName = "Hillsborough County Solid Waste", City = "Tampa", ItemsAccepted = 1, Latitude = 27.909443, Longitude = -82.495022, PhoneNumber = "(813) 555-5555", Rating = 5, Recycles = 1, State = "FL", Zip = "33629", weekdayHours = "" },
                        new { Id = -9, Address = "789 false ave", CenterName = "Manatee County Solid Waste", City = "Sarasota", ItemsAccepted = 0, Latitude = 27.342242, Longitude = -82.494311, PhoneNumber = "(941) 222-2222", Rating = 4, Recycles = 0, State = "FL", Zip = "34232", weekdayHours = "" },
                        new { Id = -10, Address = "789 false ave", CenterName = "Manatee County Solid Waste", City = "Sarasota", ItemsAccepted = 0, Latitude = 27.342242, Longitude = -82.494311, PhoneNumber = "(941) 222-2222", Rating = 4, Recycles = 0, State = "FL", Zip = "34232", weekdayHours = "" },
                        new { Id = -12, Address = "1000 62nd Ave. N.E.", CenterName = "Pinellas County Recycling & Brush Site", City = "St. Petersburg", ItemsAccepted = 3, Latitude = 27.875891, Longitude = -82.67545, PhoneNumber = "(727) 464-7500", Rating = 3, Recycles = 3, State = "FL", Zip = "33702", weekdayHours = "" },
                        new { Id = -11, Address = "789 false ave", CenterName = "Manatee County Solid Waste", City = "Sarasota", ItemsAccepted = 0, Latitude = 27.342242, Longitude = -82.494311, PhoneNumber = "(941) 222-2222", Rating = 4, Recycles = 0, State = "FL", Zip = "34232", weekdayHours = "" }
                    );
                });
