...
namespace recyclemeapi.Migrations
{
    ...
    [Migration("20181129183508_new oneone")]
    partial class newoneone
    {
            ...
            modelBuilder.Entity("recyclemeapi.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = -15, Address = "1023 Gulf Rd", CenterName = "Tarpon Springs Fire Rescue Station 70", City = "Tarpon Springs", Latitude = 29.333, Longitude = 82.333, PhoneNumber = "", Rating = 4, State = "FL", Zip = "34689", weekdayHours = "", weekendHours = "" },
                        new { Id = -16, Address = "898 S Levis Ave.", CenterName = "Tarpon Springs Yard Waste Facility", City = "Tarpon Springs", Latitude = 27.342242, Longitude = -82.494311, PhoneNumber = "(727) 943-0067", Rating = 4, State = "FL", Zip = "34689", weekdayHours = "7am - 4:30pm", weekendHours = "Saturday, 7am - 12pm" }
                    );
                });
