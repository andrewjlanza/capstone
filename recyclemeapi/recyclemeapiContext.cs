...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<Location>().HasData(
        ...
        new Location { Id = -5, CenterName = "Pinellas County Recycling & Brush Site", Address = "2500 26th Ave. S.", City = "St. Petersburg", State = "FL", Zip = "33712", PhoneNumber = "", Rating = 3, Latitude = 27.875891, Longitude = -82.675450, weekdayHours = "Monday-Friday, 9 a.m. to 5:30 p.m.", weekendHours = "Saturday and Sunday, 8 a.m. to 5:30 p.m." },
        ...
        new Location
        {
          ...
          new Location { Id = -15, CenterName = "Tarpon Springs Drop-Off", Address = "1023 Gulf Rd", City = "Tarpon Springs", State = "FL", Zip = "34689", PhoneNumber = "", Rating = 4, Latitude = 27.342242, Longitude = -82.494311, weekdayHours = "", weekendHours = "" }
